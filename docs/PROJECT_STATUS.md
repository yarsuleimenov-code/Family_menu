...
> Актуальная точка отсчёта аудита 2026-07-18: `docs/agent-handoff.md`. Результаты прежних live-проверок ниже являются историческими до повторного разрешённого smoke.
